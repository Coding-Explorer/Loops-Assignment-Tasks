///////////////TASK 05/////////////////.
/* Exploring the Arrays with Loops(Using loop ).
...
//Here's firstly i'm gonna to Create an empty array.
var myArray = [];
//Now the second step is to Run a loop 10 times, adding a new incrementing value to the array.
for (var i = 1; i <= 10; i++) {
    myArray.push("Value-".concat(i));
}
//The third step would be to Log the array into the console with the specified format using a for loop.
console.log('INDEX           VALUE');
for (var i = 0; i < myArray.length; i++) {
    console.log("   ".concat(i, "            ").concat(myArray[i]));
}
//Now finally last step is to Use the for...of loop to output the value into the console from the array.
